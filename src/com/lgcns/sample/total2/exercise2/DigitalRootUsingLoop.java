package com.lgcns.sample.total2.exercise2;
 ...
 * 
 */
public class DigitalRootUsingLoop {
	public static void main(String args[]) {
		int[] inputs = {24, 39, 3222};
		
		for(int input:inputs) {
			System.out.println("Input : " + input + "    Digital Root: " + calculateDigitalRoot(input));
		}
	}
	
	private static int calculateDigitalRoot(int input) {
		while(input >= 10) {
			int digitalRoot = 0;
